...
// Route::post('blog/{slug}', array('as' => 'comments.edit', 'uses' => 'CommentController@edit'));
...
// Route::post('comments/{slug}', array('as' => 'comments.store', 'uses' => 'CommentController@store'));

Route::post('comments/{slug}', array('as' => 'comments.delete', 'uses' => 'CommentController@delete'));
